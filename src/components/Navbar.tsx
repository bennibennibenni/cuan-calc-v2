...
export const Navbar = React.forwardRef<HTMLElement, NavbarProps>(
  ({ className = '', ...props }, ref) => (
    <nav
      ref={ref}
      className={`w-full backdrop-blur-sm bg-white/[0.02] border-b border-white/5 ${className}`.trim()}
      aria-label='Main'
      {...props}
    >
        ...
        <ul className='flex items-center gap-1'>
          <li>
            <a
              ...
              className='flex rounded-md p-2 text-gray-500 outline-hidden transition hover:text-gray-300 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900'
