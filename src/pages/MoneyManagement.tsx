      ...
      <div className='mx-auto max-w-[1200px] px-4 sm:px-6 md:px-12'>
        <header className='mt-8 sm:mt-12 mb-6 sm:mb-8 flex items-start justify-between gap-3 sm:gap-4 lg:mt-24'>
          <div className='min-w-0'>
            <h1 className='font-heading-md sm:font-heading-lg text-gray-100'>Money Management</h1>
            <p className='mt-1 sm:mt-2 text-xs sm:text-sm text-gray-400 md:text-base'>Choose a calculation feature to manage your finances</p>
          </div>
          <button
            type='button'
            onClick={() => navigate('/')}
