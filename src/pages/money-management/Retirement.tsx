      ...
      <section className='space-y-6'>
        <header className='flex items-start justify-between gap-4'>
          <div className='flex min-w-0 items-start gap-4'>
            ...
            <div className='min-w-0'>
              <h1 className='font-heading-md text-gray-100 md:text-[2rem]'>Retirement</h1>
              <p className='mt-1 text-sm text-gray-400 md:text-base'>Plan your retirement savings projection</p>
            </div>
          </div>
          <button
            type='button'
