      ...
      <section className='space-y-6'>
        <header className='flex items-start justify-between gap-4'>
          <div className='flex min-w-0 items-start gap-4'>
            <div className='flex h-10 w-10 shrink-0 items-center justify-center text-white md:h-12 md:w-12'>
            ...
            <div className='min-w-0'>
              ...
              <p className='mt-1 text-xs text-gray-400 md:text-base'>Basic calculator with keyboard support</p>
            </div>
          </div>
          <button
            type='button'
        ...
        <div className='mx-auto max-w-md space-y-4'>
          ...
          <div className='rounded-2xl border border-white/6 bg-white/[0.03] p-4 md:p-6 space-y-3'>
            ...
            {result && (
              <div className='rounded-2xl border border-white/6 bg-violet-500/10 p-3.5 md:p-4 overflow-x-auto'>
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isClear 
                        ? 'col-span-3 border border-red-500/20 bg-red-500/10 text-red-400 hover:bg-red-500/20 focus-visible:ring-red-500' 
                        : isBackspace
                        ? 'border border-amber-500/20 bg-amber-500/10 text-amber-300 hover:bg-amber-500/20 focus-visible:ring-amber-500'
                        : isEquals
